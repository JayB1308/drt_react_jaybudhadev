...
export const ATTR_OPTIONS = [
  ...
  { label: "NORAD CAT ID", value: "noradCatId" },
  ...
  { label: "International Designation", value: "intlDes" },
  { label: "Decay Date", value: "decayDate" },
  { label: "Launch Site Code", value: "launchSiteCode" },
];

export const ORBIT_CODE_OPTIONS = [
  { label: "LEO", value: "{LEO}" },
  { label: "LEO1", value: "{LEO1}" },
  { label: "LEO2", value: "{LEO2}" },
  { label: "LEO3", value: "{LEO3}" },
  { label: "LEO4", value: "{LEO4}" },
  { label: "MEO", value: "{MEO}" },
  { label: "GEO", value: "{GEO}" },
  { label: "HEO", value: "{HEO}" },
  { label: "IGO", value: "{IGO}" },
